...
public class SchedulingServiceTimeValidationTest {

    @Test
    void shouldThrowErrorWhenNoTimeIsSelected() {
        ...
        assertThatThrownBy(() -> service.requestAppointment(client, vet, date, null, null))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessage("horário deve ser selecionado");
